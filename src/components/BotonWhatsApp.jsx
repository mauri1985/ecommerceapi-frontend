    ...
    <div className="fixed bottom-6 right-6 z-40" ref={ref}>
      ...
      >
        <div className="bg-green-500 text-white px-4 py-3 flex justify-between items-center">
          <div>
            <p className="font-semibold text-sm">MauriShop</p>
        ...
        <div className="p-4 bg-slate-50">
          ...
          <textarea
            ...
            rows={3}
            className="w-full border border-slate-300 rounded-lg px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-green-500 resize-none"
          />
